...
Run a stateful `/grill-me` session whose only durable output is **workflow** specs. Use dependency-aware rounds with a recommended answer for every question, aimed at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
