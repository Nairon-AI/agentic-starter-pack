...
Apply `principle-type-system-discipline` first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Validate where data crosses in; trust types inside. Read `brain/principles/boundary-discipline.md`. |
