...
**One agent prompt -> starter AGENTS.md -> 186 portable skills + brain vault**
...
[![Skills](https://img.shields.io/badge/Skills-186-111827.svg)](#skill-catalog)
...
- **186 skills** - task-specific workflows for context, planning, frontend polish, engineering cleanup, security, writing, and marketing. They give agents concrete procedures instead of vibes.
...
- `grill-me`, `plan`, `prd-to-issues`, `prd-to-plan`, `premortem`, `scaffold-exercises`, `to-issues`, `to-prd`, `write-a-spec`
