...
- If on a feature branch, diff against the repository's declared target or merge base (for example `git diff origin/main...HEAD`)
...
5. **Note disagreements**. If one reviewer flags something and another explicitly says the opposite, preserve that context.
