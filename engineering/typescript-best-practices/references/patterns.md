...
Code examples for each rule in `SKILL.md`. The language-agnostic rules live in `principle-type-system-discipline`; validation placement lives in `brain/principles/boundary-discipline.md`.
...
Validate once where data crosses in; trust types inside. Read `brain/principles/boundary-discipline.md`.
